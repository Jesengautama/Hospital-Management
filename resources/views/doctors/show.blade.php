...
<div class="max-w-7xl mx-auto p-6">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-semibold">Detail Dokter</h1>
        <div class="flex items-center space-x-3">
            <a href="{{ route('doctors.edit', $doctor) }}" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                Edit
            </a>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white shadow rounded-lg overflow-hidden">
                <div class="bg-gradient-to-r from-purple-600 to-purple-700 px-6 py-4">
                    <h2 class="text-xl font-semibold text-white">{{ $doctor->name }}</h2>
                    <p class="text-purple-100">{{ $doctor->specialty->name }}</p>
                </div>
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="text-gray-900">{{ $doctor->hospital->name }}</p>
                            <p class="text-sm text-gray-500">{{ $doctor->hospital->city }}</p>
                        </div>
                        ...
                        @if($doctor->description)
                            <div>
                                ...
                                <p class="text-gray-900">{{ $doctor->description }}</p>
                            </div>
                        @endif
                        
                        <div>
                            <h3 class="text-sm font-medium text-gray-600">Jumlah Jadwal</h3>
                            <p class="text-2xl font-bold text-purple-600">{{ $doctor->schedules->count() }}</p>
                        </div>
                        
                        <div>
                            <h3 class="text-sm font-medium text-gray-600">Total Reservasi</h3>
                            <p class="text-2xl font-bold text-purple-600">{{ $doctor->reservations->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <h2 class="text-lg font-semibold text-gray-900">Jadwal Praktik</h2>
                        <a href="{{ route('schedules.create') }}" class="px-3 py-1 bg-blue-600 text-white text-sm rounded hover:bg-blue-700">
                            Tambah Jadwal
                        </a>
                    </div>
                </div>
                ...
                @else
                    <div class="p-8 text-center">
                        ...
                        <p class="text-gray-500 mb-4">Dokter ini belum memiliki jadwal praktik.</p>
            ...
            <div class="bg-white shadow rounded-lg overflow-hidden">
                ...
                @if($doctor->reservations->count() > 0)
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($doctor->reservations->take(5) as $reservation)
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap">
                ...
                @else
                    <div class="p-8 text-center">
                        ...
                        <p class="text-gray-500">Dokter ini belum memiliki reservasi.</p>
                    </div>
                @endif
            </div>
        </div>
